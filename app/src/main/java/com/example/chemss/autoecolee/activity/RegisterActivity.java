...
import com.example.chemss.autoecolee.Accueil;
import com.example.chemss.autoecolee.Connexion;
import com.example.chemss.autoecolee.R;
import com.example.chemss.autoecolee.SuiteInscription;
        ...
        public class RegisterActivity extends Activity {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (!error) {
                                ...
                                Intent intent = new Intent(RegisterActivity.this,Connexion.class);
                                startActivity(intent);
                                finish();
                            } else {
            ...
            public boolean onOptionsItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.Accueil: {
                        Intent intent = new Intent(RegisterActivity.this, Accueil.class);
                        startActivity(intent);
                    }
                    return true;
